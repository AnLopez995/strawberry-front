export default function Body() {
    return (
        <div>
            ...
            <h1 className="text-black text-4xl font-bold text-center mt-10">Bienvenidos a mi tienda</h1>
            <p className="text-black text-center">Aquí encontrarás los mejores productos</p>
        </div>
